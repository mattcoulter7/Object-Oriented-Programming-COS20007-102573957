            ...
            while (false == SwinGame.WindowCloseRequested())
            {
                ...
                if (SwinGame.MouseClicked(MouseButton.LeftButton))
                {
                    ...
                    else if (kindToAdd == ShapeKind.Line)
                    {
                        ...
                        newLine.X2 = newLine.X + Convert.ToSingle(newLine.Length * Math.Cos(newLine.Angle * Math.PI/180));
                        newLine.Y2 = newLine.Y + Convert.ToSingle(newLine.Length * Math.Sin(newLine.Angle * Math.PI/180));
